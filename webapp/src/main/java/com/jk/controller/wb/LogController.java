...
public class LogController {
    ...
    /**
     * 功能描述: 查询日志+分页
     * @param: [page, rows, timestart, timeend]
     * @return: java.util.Map<java.lang.String,java.lang.Object>
     * @auther: 王博
     * @date: 2018/5/13 21:51
     */
    @RequestMapping("queryRiZhi")
    @ResponseBody
    public Map<String,Object> queryBookList(Integer page, Integer rows, String timestart, String timeend){
