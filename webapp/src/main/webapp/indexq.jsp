...
<div class="header">
	<div class="topbar">
        ...
        <span class="item"><a href="loginq.jsp">登录</a></span><span class="item"><a href="loginq.jsp">注册</a></span>&nbsp;<span class="hr-line">|</span>
    ...
    <div class="nav">
    	<ul class="cate">
        	...
        	<li class="font16"><a href="applyfree.jsp">免费申请</a></li>
            <div class="clear"></div> 
        </ul>
...
<div class="flexslider">
	<ul class="slides">
		...
		<li style="background:url(image/banner/img5.jpg) 50% 0 no-repeat;"><a href="#">html</a></li>
        <li style="background:url(image/banner/i1920x487-2.jpg) 50% 0 no-repeat;"><a href="#">html5</a></li>
	</ul>
</div>
<!--回到顶部-->
...
<!--hotbox start-->
    ...
    <div class="column">
        ...
        <div class="theme">
        	<div class="themepic "><a href="#"><img src="image/images/theme1.jpg"></a></div>
            <div class="themenum"><span class="font32">3</span>期</div>
            <div class="themename font16"><a href="#">超CHIC办公室女郎</a></div>
            <div class="themebox">
            	<div class="thegoods"><a href="#"><img src="image/images/thegood1.jpg"></a></div>
                <div class="thegoods"><a href="#"><img src="image/images/thegood1.jpg"></a></div>
                <div class="thegoods"><a href="#"><img src="image/images/thegood1.jpg"></a></div>
                <div class="thegoods"><a href="#"><img src="image/images/thegood1.jpg"></a></div>
        ...
        <div class="theme">
        	<div class="themepic "><img src="image/images/theme1.jpg"></div>
            <div class="themenum"><span class="font32">4</span>期</div>
            <div class="themename font16">超CHIC办公室女郎</div>
            <div class="themebox">
            	<div class="thegoods"><img src="image/images/thegood1.jpg"></div>
                <div class="thegoods"><img src="image/images/thegood1.jpg"></div>
                <div class="thegoods"><img src="image/images/thegood1.jpg"></div>
                <div class="thegoods"><img src="image/images/thegood1.jpg"></div>
        ...
        <div class="colwrap">
        	<div class="dress"><!--1-->
            	<div class="dresspic picbox">
                	<a href="#"><img src="image/images/dress2.jpg"></a>
                    <div class="pictext">
        	...
        	<div class="dress"><!--2-->
            	<div class="dresspic picbox">
                	<a href="#"><img src="image/images/dress4.jpg"></a>
                    <div class="pictext">
                		<div class="text"><a href="#">2012新品男T恤韩版短袖男士夏装男装翻领t恤POLO衫 货到付款 T93</a> </div>
                        <div class="grayer">原价：￥58</div>
            		</div>
        	...
        	<div class="dress"><!--3-->
            	<div class="dresspic picbox">
                	<a href="#"><img src="image/images/dress3.jpg"></a>
                    <div class="pictext">
                		<div class="text"><a href="#">2012新品男T恤韩版短袖男士夏装男装翻领t恤POLO衫 货到付款 T93</a> </div>
                        <div class="grayer">原价：￥58</div>
            		</div>
        	...
        	<div class="dress" style="margin-right:0;"><!--4-->
            	<div class="dresspic picbox">
                	<a href="#"><img src="image/images/dress1.jpg"></a>
                    <div class="pictext">
                		<div class="text"><a href="#">2012新品男T恤韩版短袖男士夏装男装翻领t恤POLO衫 货到付款 T93</a> </div>
                        <div class="grayer">原价：￥58</div>
            		</div>
    ...
    <div class="column">
        ...
        <div class="colwrap">
        	<div class="dress"><!--1-->
            	<div class="dresspic">
                	<a href="image/images/dress3.jpg" class="tooltip"><img src="image/images/dress1.jpg"></a>
                </div>
                <div class="dressprice">
                	<div class="sl"><a href="#" class="orange"><h3>￥</h3><h1>27.0</h1></a></div>
                    <div class="sr">
