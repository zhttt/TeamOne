...
<script src="<%=request.getContextPath() %>/js/autoplay.js" type="text/javascript"></script>
<script src="<%=request.getContextPath() %>/js/jquery.validate.js"></script>
</head>
<body>
<div class="head">
	<div class="logo fl"><img src="<%=request.getContextPath() %>/image/logo.png"></div>
	<div class="nav fl">
		<ul class="font16">
        	<li><a href="indexq.jsp">首页</a></li>
        	...
        	<li class="mline m1"></li>
        	<li><a href="theme.jsp">主题购</a></li>
        	<li class="mline m1"></li>
        	<li><a href="applyfree.jsp">免费申领</a></li>
        </ul>
	</div>
	<div class="clear"></div>
</div> 
<div class="container">
	<div class="content">
		<div id="scrollbox" class="fl">
			<ul>
		    	<li><img src="image/banner/scroll1.png" /></li>
		    	<li><img src="image/banner/scroll2.png" /></li>
		    	<li><img src="image/banner/scroll3.png" /></li>
		    	<li><img src="image/banner/scroll3.png" /></li>
			</ul>
			<ol class="dot">
				<li class="curdot"></li>
...
<<<<<<< HEAD
    	...
    	<div class="cooper">
        	<div class="font16 abtitle">组员名称</div>
            <ul class="gray">
                <li>组长：赵航天</li>
                <li>组员：刘新，小波，王博</li>
                <li>组员；马楠，郭宽宽，杨强</li>
